...
CRATE_DIR="$ROOT_DIR/crypto/decmed-iota"
...
for target_pair in "${TARGETS[@]}"; do
  ...
  cp "$CRATE_DIR/target/$rust_target/release/libdecmed_iota.so" "$JNI_LIBS_DIR/$abi/"
done

echo "Packaged libdecmed_iota.so into $JNI_LIBS_DIR"
